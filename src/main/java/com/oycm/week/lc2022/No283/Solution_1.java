package com.oycm.week.lc2022.No283;
...
public class Solution_1 {
    ...
    /**
     * 2194. <a href="https://leetcode.cn/problems/cells-in-a-range-on-an-excel-sheet/description/">Excel 表中某个范围内的单元格</a> 1253
     *
     * @param s
     * @return
     */
    public List<String> cellsInRange(String s) {
        ...
        Excel 表中的一个单元格 (r, c) 会以字符串 "<col><row>" 的形式进行表示，其中：
            <col> 即单元格的列号 c 。用英文字母表中的 字母 标识。例如，第 1 列用 'A' 表示，第 2 列用 'B' 表示，第 3 列用 'C' 表示，以此类推。
